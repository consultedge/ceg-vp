...
import AiReminder from './AiReminder-updated';
    ...
    <div>
      ...
      <div className="mb-4">
        <ul className="nav nav-tabs">
          ...
          <li className="nav-item">
            <button
              className={`nav-link ${activeTab === 'emiremindertest' ? 'active' : ''}`}
              onClick={() => setActiveTab('emiremindertest')}
            >
      ...
      <div className="tab-content">
        ...
        {activeTab === 'emiremindertest' && <AiReminder />}
      </div>
    </div>
  );
}
